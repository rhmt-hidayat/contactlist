                                ...
                                <form method="POST" action="<?php echo base_url('Project/update') ?>">
                                    ...
                                    <div class="card-body">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="kode" class="form-control" required placeholder="Code Name" style="text-transform: capitalize;" maxlength="150" autocomplete="off" value="<?php echo $edit['kode_project'] ?>">
                                            <input type="hidden" name="id" value="<?php echo $edit['id'] ?>">
                                        </div>
                                        <div class="form-group">
                                            <label class="control-label">Nama Project</label>
                                            <input type="text" name="nama" class="form-control" required placeholder="Project Name" maxlength="150" autocomplete="off" value="<?php echo $edit['nama_project'] ?>">
                                        </div>
                                    </div>
