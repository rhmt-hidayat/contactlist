                                ...
                                <form method="POST" action="<?php echo base_url('User/update') ?>">
                                    ...
                                    <div class="card-body">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="nama" class="form-control" required placeholder="Full Name" style="text-transform: capitalize;" maxlength="150" autocomplete="off" value="<?php echo $edit['nama'] ?>">
                                            <input type="hidden" name="userid" value="<?php echo $edit['userid'] ?>">
                                        </div>
                                        <div class="form-group">
                                            <label class="control-label">Email Address</label>
                                            <input type="email" name="email" class="form-control" required placeholder="Email Address" maxlength="150" autocomplete="off" value="<?php echo $edit['email']; ?>">
                                        </div>
                                        <div class="form-group">
                                            <label class="control-label">Level</label>
                                            <select name="level" class="form-control select2bs4" required>
                                                <option value="">Select Level</option>
                                                <option value="0" <?php if($edit['level'] == '0'){ ?> selected <?php } ?>>Administrator</option>
                                                <option value="1" <?php if($edit['level'] == '1'){ ?> selected <?php } ?>>User</option>
                                            </select>
                                        </div>
                                        <div class="form-group">
                                            <label class="control-label">Description</label>
                                            <textarea name="deskripsi" class="form-control" placeholder="Your Description Here..."><?php echo $edit['deskripsi'] ?></textarea>
                                        </div>
                                    </div>
                                    <div class="card-footer">
                                        <a href="<?php echo base_url().'User'; ?>" data-tooltip="tooltip" data-placement="top" title="Cancel" class="btn btn-flat btn-default"><i class="fas fa-times"></i> Cancel</a>
