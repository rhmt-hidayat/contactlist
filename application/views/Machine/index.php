            ...
            <section class="content">
                <div class="container-fluid">
                    ...
                    <div class="row">
                        <div class="col-4">
                            <div class="card">
                                <form method="POST" action="<?php echo base_url('Machine/insert') ?>">
                                    ...
                                    <div class="card-body">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="no_mesin" class="form-control" required placeholder="No Mesin" style="text-transform: capitalize;" maxlength="150" autocomplete="off">
                                        </div>
                                        <div class="form-group">
                                            <label class="control-label">Tonage</label>
                                            <input type="text" name="tonnage" class="form-control" required placeholder="Tonnage" maxlength="150" autocomplete="off">
                                        </div>
                                    </div>
