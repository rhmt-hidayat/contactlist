            ...
            <section class="content">
                <div class="container-fluid">
                    ...
                    <div class="row">
                        <div class="col-4">
                            <div class="card">
                                <form method="POST" action="<?php echo base_url('Type/insert') ?>">
                                    <div class="card-header">
                                        .:: Add New Abnormality Type ::.
                                    </div>
                                    <div class="card-body">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="nama" class="form-control" required placeholder="Abnormality Type Name" maxlength="150" autocomplete="off">
                                        </div>
                                    </div>
