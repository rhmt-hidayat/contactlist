                            ...
                            <div class="card">
                                <form method="POST" action="<?php echo base_url('Type/update') ?>">
                                    <div class="card-header">
                                        .:: Edit New Abnormality Type ::.
                                    </div>
                                    <div class="card-body">
                                        <div class="form-group">
                                            <label class="control-label">Kode Abnormality Type</label>
                                            <input type="text" name="kode" class="form-control" required placeholder="Code Name" style="text-transform: capitalize;" maxlength="150" autocomplete="off" value="<?php echo $edit['kode_type'] ?>">
                                            <input type="hidden" name="id" value="<?php echo $edit['id'] ?>">
                                        </div>
                                        <div class="form-group">
                                            <label class="control-label">Nama Abnormality Type</label>
                                            <input type="text" name="nama" class="form-control" required placeholder="Type Name" maxlength="150" autocomplete="off" value="<?php echo $edit['nama_type'] ?>">
                                        </div>
                                    </div>
                                                ...
                                                <?php
                                                    ...
                                                    foreach($data as $row)
                                                    {
                                                        ?>
                                                            <tr>
                                                                <td><?php echo $no++; ?></td>
                                                                <td><?php echo $row->kode_type; ?></td>
                                                                <td><?php echo $row->nama_type; ?></td>
                                                                <!-- <td><?php echo $row->status; ?></td> -->
                                                                <td>
                                                                    <div class="btn-group">
                                                                        <a href="<?php echo base_url().'Type/edit/'.$row->id; ?>" class="btn btn-flat btn-xs btn-warning" data-tooltip="tooltip" data-placement="top" title="Edit Data"><i class="fas fa-edit"></i></a>
