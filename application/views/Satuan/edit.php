                                ...
                                <form method="POST" action="<?php echo base_url('Satuan/update') ?>">
                                    ...
                                    <div class="card-body">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="kode" class="form-control" required placeholder="Code Name" style="text-transform: capitalize;" maxlength="150" autocomplete="off" value="<?php echo $edit['kode_satuan'] ?>">
                                            <input type="hidden" name="id" value="<?php echo $edit['id'] ?>">
                                        </div>
                                        <div class="form-group">
                                            <label class="control-label">Nama Satuan</label>
                                            <input type="text" name="nama" class="form-control" required placeholder="Satuan Name" maxlength="150" autocomplete="off" value="<?php echo $edit['nama_satuan'] ?>">
                                        </div>
                                    </div>
                                                    ...
                                                    foreach($data as $row)
                                                    {
                                                        ?>
                                                            <tr>
                                                                ...
                                                                <td>
                                                                    <div class="btn-group">
                                                                        <a href="<?php echo base_url().'Satuan/edit/'.$row->id; ?>" class="btn btn-flat btn-xs btn-warning" data-tooltip="tooltip" data-placement="top" title="Edit Data"><i class="fas fa-edit"></i></a>
