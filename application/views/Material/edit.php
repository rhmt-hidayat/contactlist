                                ...
                                <form method="POST" action="<?php echo base_url('Material/update') ?>">
                                    ...
                                    <div class="card-body">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="kode" class="form-control" required placeholder="Kode Material" style="text-transform: capitalize;" maxlength="150" autocomplete="off" value="<?php echo $edit['kode_material'] ?>">
                                            <input type="hidden" name="id" class="form-control" value="<?php echo $edit['id']; ?>">
                                        </div>
                                        <div class="form-group">
                                            <label class="control-label">Nama Material</label>
                                            <input type="text" name="nama" class="form-control" required placeholder="Nama Material" maxlength="150" autocomplete="off" value="<?php echo $edit['nama_material'] ?>">
                                        </div>
                                        <div class="form-group">
                                            <label class="control-label">Spesifikasi</label>
                                            <input name="spesifikasi" value="<?php echo $edit['spesifikasi'] ?>" class="form-control" placeholder="Your Spesifikasi Here..."></input>
                                        </div>
                                        <div class="form-group">
                                            ...
                                            <select name="project" class="form-control select2bs4" style="width: 100%;">
                                                ...
                                                <?php
                                                    ...
                                                    {
                                                        ?>
                                                            <option value="<?php echo $p->id; ?>" <?php if($edit['id_project'] == $p->id){ ?> selected <?php } ?>><?php echo $p->nama_project; ?></option>
                                                        <?php
                                                    }
                                                ?>
                                            </select>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select name="satuan" class="form-control select2bs4" style="width: 100%;" required>
                                                ...
                                                <?php
                                                    ...
                                                    {
                                                        ?>
                                                            <option value="<?php echo $s->id; ?>" <?php if($edit['satuan'] == $s->id){ ?> selected <?php } ?>><?php echo $s->nama_satuan; ?></option>
                                                        <?php
                                                    }
                                                ?>
                                            </select>
