            ...
            <section class="content">
                <div class="container-fluid">
                    ...
                    <div class="row">
                        <div class="col-4">
                            <div class="card">
                                <form method="POST" action="<?php echo base_url('Defect/insert') ?>">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="nama" class="form-control" required placeholder="Defect Name" maxlength="150" autocomplete="off">
                                        </div>
                                    </div>
